    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(max_length=10, unique=True, null=True, verbose_name='mobile', blank=True)),
                ...
                ('user_type', models.CharField(blank=True, max_length=3, null=True, choices=[(b'CST', b'Customer'), (b'MER', b'Merchant'), (b'MAN', b'Manpower')])),
